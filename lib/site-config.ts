...
export const neighborhoods = [
  {
    name: "Summerlin",
    slug: "summerlin",
    description: "Master-planned community with parks, trails, and golf access",
    medianPrice: "$625,000",
    highlights: ["Red Rock views", "150+ parks", "Trail miles", "Golf courses"],
  },
  {
    name: "Henderson",
    slug: "henderson",
    description:
      "Nevada's second-largest city with master-planned communities and Lake Las Vegas access",
    medianPrice: "$485,000",
    highlights: [
      "Lake Las Vegas",
      "Green Valley",
  ...
  },
  {
    name: "Green Valley",
    slug: "green-valley",
    description: "Henderson community with mature landscaping and golf access",
    medianPrice: "$520,000",
  ...
  },
  {
    ...
    description: "Rapidly growing area with newer construction inventory",
    medianPrice: "$385,000",
    highlights: ["New construction", "Value price bands", "Growing inventory", "Square footage options"],
  },
  {
    name: "Skye Canyon",
    slug: "skye-canyon",
    ...
    medianPrice: "$550,000",
    highlights: ["New homes", "Mountain views", "Modern amenities", "Recreation access"],
  },
  {
    ...
    medianPrice: "$495,000",
    highlights: ["Mountain access", "Parks", "Shopping", "Trail corridors"],
  },
  {
    name: "Inspirada",
    slug: "inspirada",
    description: "Henderson master-planned community with resort-style amenities",
    medianPrice: "$525,000",
    highlights: ["Resort pools", "Walking trails", "New construction", "Amenity centers"],
  },
  {
    name: "Mountains Edge",
    slug: "mountains-edge",
