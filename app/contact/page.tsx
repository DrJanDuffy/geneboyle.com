        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6">
              Contact Dr. Gene Boyle
            </h1>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Planning an Irvine to Las Vegas move? Schedule on Calendly or call{" "}
              <strong>(702) 222-1964</strong>. Las Vegas partner support from Dr. Jan
              Duffy, BHHS Nevada Properties.
            </p>
          </div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-start bg-slate-50 rounded-lg p-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:Gene@CallDrBoyle.com"
                      className="text-blue-600 hover:text-blue-700 font-medium"
                    >
                      Gene@CallDrBoyle.com
                    </a>
                    <p className="text-sm text-slate-500 mt-1">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-slate-300">Gene@CallDrBoyle.com</div>
                </div>
              </a>
            </div>
          </section>
